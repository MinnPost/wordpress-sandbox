window["wp"] = window["wp"] || {}; window["wp"]["editPost"] =
...
function* switchEditorMode(mode) {
  ...
  if (mode !== 'visual') {
    yield external_wp_data_["controls"].dispatch(external_wp_blockEditor_["store"].name, 'clearSelectedBlock');
  }
...
function* setAvailableMetaBoxesPerLocation(metaBoxesPerLocation) {
  ...
  const postType = yield external_wp_data_["controls"].select(external_wp_editor_["store"].name, 'getCurrentPostType');

  if (window.postboxes.page !== postType) {
    window.postboxes.add_postbox_toggles(postType);
  }

  let wasSavingPost = yield external_wp_data_["controls"].select(external_wp_editor_["store"].name, 'isSavingPost');
  let wasAutosavingPost = yield external_wp_data_["controls"].select(external_wp_editor_["store"].name, 'isAutosavingPost'); // Meta boxes are initialized once at page load. It is not necessary to
  ...
  saveMetaboxUnsubscribe = Object(external_wp_data_["subscribe"])(() => {
    const isSavingPost = Object(external_wp_data_["select"])(external_wp_editor_["store"].name).isSavingPost();
    const isAutosavingPost = Object(external_wp_data_["select"])(external_wp_editor_["store"].name).isAutosavingPost(); // Save metaboxes on save completion, except for autosaves that are not a post preview.
...
function* requestMetaBoxUpdates() {
  ...
  const post = yield external_wp_data_["controls"].select(external_wp_editor_["store"].name, 'getCurrentPost');
  ...
  try {
    ...
    yield external_wp_data_["controls"].dispatch(store.name, 'metaBoxUpdatesFailure');
  }
}
/**
...
function* __unstableSwitchToTemplateMode(template) {
  ...
  const isWelcomeGuideActive = yield external_wp_data_["controls"].select(store.name, 'isFeatureActive', 'welcomeGuideTemplate');
...
// CONCATENATED MODULE: ./packages/edit-post/build-module/components/edit-post-settings/index.js
/**
 * WordPress dependencies
 */
...
// CONCATENATED MODULE: ./packages/edit-post/build-module/components/header/template-title/edit-template-title.js
...
// CONCATENATED MODULE: ./packages/edit-post/build-module/components/header/template-title/template-description.js
...
//# sourceMappingURL=index.js.map
// CONCATENATED MODULE: ./packages/edit-post/build-module/components/sidebar/post-link/index.js
...
//# sourceMappingURL=index.js.map
// CONCATENATED MODULE: ./packages/edit-post/build-module/components/sidebar/template/actions.js
...
//# sourceMappingURL=actions.js.map
// CONCATENATED MODULE: ./packages/edit-post/build-module/components/sidebar/template/index.js
